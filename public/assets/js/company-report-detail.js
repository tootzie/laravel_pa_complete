...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    loadChartData(company, defaultYear);
    ...
    document.querySelectorAll('#tahunDropdown .dropdown-item').forEach(function(item) {
        item.addEventListener('click', function() {
            ...
            loadChartData(company, selectedYear);

            // Send an AJAX request to fetch data for the selected year
            fetch(`/get-chart-data-company/${company}/${selectedYear}`)
    ...
    function loadChartData(company, year) {
        fetch(`/get-chart-data-company/${company}/${year}`)
