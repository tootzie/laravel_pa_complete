...
@section('title', ' Akses User - Tambah')
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Tambah Akses User</h5>
      </div>
      <div class="card-body">
        <form action="{{ route('user-akses-store') }}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <input type="text" id="email" name="email" class="form-control" placeholder="john.doe@sby.wingscorp.com" aria-label="john.doe" aria-describedby="basic-default-email2" />
                    ...
                    <div class="input-group input-group-merge">
                        <select id="user_choice" name="user_choice" class="form-select select2">
                            ...
                            @foreach ($users as $user)
                                <option value="{{$user->ektp_atasan}}" data-nama-atasan="{{$user->nama_atasan}}">{{$user->nama_atasan}}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('user_choice')
          ...
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="ektp">E-KTP</label>
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <input type="text" id="ektp" name="ektp" class="form-control" placeholder="356878110000002" aria-label="john.doe" aria-describedby="basic-default-email2" readonly/>
                <!-- <span class="input-group-text" id="basic-default-email2">@example.com</span> -->
              </div>
              @error('ektp')
                <small class="text-danger">{{ $message }}</small>
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <select id="role_name" name="role_name" class="form-select">
                    <option value="00">Pilih Role User</option>
